...
class Solicitud(ModeloBase):
    ...
    def get_all(cls):
        ...
        sql = '''
                SELECT user.first_name, user.last_name,token.key as token_usuario,detalle_usuario.foto, solicitud.token, solicitud.estado, solicitud.fecha_creacion,solicitud.path_Pdf, solicitud.id, solicitud.motivo_rechazo
