...
class ConsejoDia(ModeloBase):
    ...
    fijado = models.BooleanField(default=0)
    ...
    def get_consejos_del_dia(cls):
        ...
        sql = '''
            SELECT consejo_dia.fijado, informacion, imagen, consejo_dia.path, consejo_dia.token, usuario.username, usuario.email, usuario.first_name, usuario.last_name, detalle_usuario.foto
            ...
            WHERE consejo_dia.ultimo_cambio >= NOW() - INTERVAL 1 DAY OR consejo_dia.fijado;
        '''
